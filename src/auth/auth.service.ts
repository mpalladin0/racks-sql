...
import { ApplicationRefreshStatusEvent } from 'src/applications/forms/event/ApplicationRefreshStatus.event';
    ...
    async validateUser(username: string, pass: string) {
        ...
        if (user) {
            ...
            if (isMatch) {
                ...
                this.eventEmitter.emit('applications.status.refresh', new ApplicationRefreshStatusEvent(user.uuid))
